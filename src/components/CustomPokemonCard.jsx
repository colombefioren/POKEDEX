   ...
   <Link to={`/pokemon/custom/${pokemon.name}`}>
    ...
    >
      ...
      >
        ...
        <div className="absolute -bottom-2 -right-2 z-50 flex gap-1.5 pointer-events-auto">
          <motion.button
          ...
          <motion.button
            ...
            className={`
              ...
              ${
                isDarkMode
                  ? "bg-red-900/50 border border-red-700/50 text-red-100 hover:bg-red-900/70"
        ...
        <div className="px-4 pb-8 pt-5 flex flex-col h-full relative z-10">
          <div className="flex justify-between items-start min-h-[70px]">
            ...
            <div className="relative mb-2 flex-1 text-right">
              <h3
                ...
                title={pokemon.displayName || pokemon.name.replace(/-/g, " ")}
              >
                {pokemon.displayName || pokemon.name.replace(/-/g, " ")}
              </h3>
            </div>
          </div>
          ...
          <div className="relative h-50 flex items-center justify-center my-2">
            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center">
              ...
              {!isLoaded && !hasError && pokemon.image && (
