        ...
        <div className="p-6">
          {isLoading ? (
            ...
            <>
              ...
              <div className="mt-6">
                <h4 className="text-sm font-semibold text-gray-400 mb-1">EFFECT</h4>
                <p className="text-white">{safeAbility.effect}</p>
              </div>
              
              <div className="mt-4">
                <h4 className="text-sm font-semibold text-gray-400 mb-1">IN BATTLE</h4>
                <p className="text-white">{safeAbility.shortEffect}</p>
              </div>
              ...
              {safeAbility.name !== 'unknown' && (
                <a
                  ...
                  className={`mt-6 inline-flex items-center px-4 py-2 rounded-lg ${typeStyle.bg || 'bg-blue-500'} text-white hover:opacity-90 transition-opacity`}
                >
